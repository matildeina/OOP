...
# 4. melakukan nested looping, looping pertama itu berdasrkan tinggi, looping kedua itu berdasarkan lebar gambar
# 5. ambil array item menggunakan img.item(i, j) berdasarkan looping, fungsinya itu untuk mengambil setiap pixel.
# 5. lalu validasi jika nilai item (pixel) = 180 maka ubah pixel menjadi 0
# 5. lalu validasi jika nilai item (pixel) <180 maka ubah pixel menjadi 1
# 5. lalu validasi jika nilai item (pixel) > 180 maka ubah pixel menjadi 255 
# 7. lalu mengubah nilai array item (pixel) menggunakan img.itemset() berdasarkan hasil validasi tersebut
